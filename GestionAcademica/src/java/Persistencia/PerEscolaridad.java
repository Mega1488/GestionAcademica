 ...
 * @author alvar
 */
public class PerEscolaridad implements InABMGenerico{
   ...
   private void iniciaOperacion() throws HibernateException {
    ...
    public Object guardar(Object pObjeto) {
        ...
        Retorno_MsgObj retorno = new Retorno_MsgObj(new Mensajes("Error al guardar", TipoMensaje.ERROR), escolaridad);

        escolaridad.setObjFchMod(new Date());
        
        try {
            iniciaOperacion();
            escolaridad.setEscCod((Long) sesion.save(escolaridad));
            tx.commit();
            
            retorno = new Retorno_MsgObj(new Mensajes("Guardado correctamente", TipoMensaje.MENSAJE), escolaridad);
    ...
    public Retorno_MsgObj obtener(Object pObjeto) {
        ...
        try {
            iniciaOperacion();
            Escolaridad escolaridad = (Escolaridad) sesion.get(Escolaridad.class, codigo);
            retorno = new Retorno_MsgObj(new Mensajes("Ok", TipoMensaje.MENSAJE), escolaridad);
    ...
    public Retorno_MsgObj obtenerLista() {
        ...
        try {
            ...
            List<Object> listaRetorno = sesion.getNamedQuery("Escolaridad.findAll").list();
    ...
    public Retorno_MsgObj obtenerListaByAlumno(Long PerCod) {
        ...
        try {
            ...
            List<Object> listaRetorno = sesion.getNamedQuery("Escolaridad.findByAlumno")
